						...
						if i == '1':
							...
							if l == 'stay':
								...
								if iitems[g] == 'Зелье Здоровья':
									...
									damage = 10
									damage = damage + (damag[items.index(iitems[g])]) + meindamage[l]+ 50*power
									weapon = nameiitems[g]
							os.system("cls")
						elif i == '4':
							os.system("cls")
							...
							print('У вас осталось'+healthmy+'HP')
							work = False
						if healthenemy <= 0:
					...
					while work == True and healthenemyhard>0 and healthmy > 0:
						...
						if i == '1':
							...
							if l == 'stay':
								...
								if iitems[g] == 'Зелье Здоровья':
									healthmymax += 50
									print('Ваше максимальное здоровье увеличилось, теперь оно равно '+ healthmymax)
									print('Ваше действительное здоровье равно '+ healthmy)
								elif iitems[g] == 'Зелье силы':
									power = 1
								else:
						...
						if healthmy <= 0:
							...
							stage = 0
					healthenemyhard = BOSS[0]
				elif enemizer >= 4 and enemizer <= 6:
					...
					while work == True:
						...
						if inp == '1':
							...
							for i in range(3):
								...
								number.append(items.index(chose[i]))
								...
								n = i + 1
								print()
								print(n,')',line11[i] + ' ' + line21[i] +' '+chose[i],'(',cost[items.index(chose[i])],')')
							print()
							print('Выбирай!')
							chois = input()
							chhh = int(chois) - 1
							if chois == '1':
								if money >= cost[number[int(chois)]]:
									...
									nameiitems.append(line11[chhh] +line21[chhh] +items[number[1]])
								...
								if money >= cost[number[int(chois)]]:
									...
									nameiitems.append(line11[chhh] +line21[chhh] +items[number[2]])
									meindamage.append(int(line12[chhh])+int(line22[chhh]))
								else:
									print('У вас недостаточно денег')
							elif chois == '3':
								if money >= cost[number[int(chois)]]:
									...
									nameiitems.append(line11[chhh] +line21[chhh] +items[number[3]])
									meindamage.append(int(line12[chhh])+int(line22[chhh]))
