						...
						if inp == '1':
							...
							if chois == '1':
								if money >= cost[number[int(chois)]]:
									...
									iitems.append(line11[chhh] +line21[chhh] +items[number[1]])
								...
								if money >= cost[number[int(chois)]]:
									money = money - cost[number[int(chois)]]
									print('Покупка совершена, ваш остаток '+ str(money) + ' монет')
									iitems.append(line11[chhh] +line21[chhh] +items[number[2]])
									meindamage.append(int(line12[chhh])+int(line22[chhh]))
								else:
									print('У вас недостаточно денег')
							elif chois == '3':
								if money >= cost[number[int(chois)]]:
									...
									iitems.append(line11[chhh] +line21[chhh] +items[number[3]])
									meindamage.append(int(line12[chhh])+int(line22[chhh]))
