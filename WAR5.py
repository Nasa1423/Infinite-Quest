...
iitems = []
nameiitems = []
cost = [50,70,110,150,80,250,400,200,500]
			...
			if hard == True:
						...
						if healthenemy <= 0:
							...
							if questxp == True:
								...
								if questxpvalue >= questxpneed:
									print('Вы выполнили квест на опыт! Можете его сдать!')
							level = xp // 50
							print('Ваш lvl равен '+ str(level))
							if questmoney == True:
								questmoneyvalue += add
								if questmoneyvalue >= questmoneyneed:
									print('Вы выполнили квест на деньги! Можете его сдать!')
							money = money + add
							work = False
						if healthmy <= 0:
							print(Style.RESET_ALL)
				...
				if p == 1:
					while work == True:
						...
						if inp == '1':
							...
							if chois == '1' or chois == '2' or chois == '3':
								chhh = int(chois) - 1
							if chois == '1':
								if money >= cost[items.index(chose[chhh])]:
									money = money - cost[items.index(chose[chhh])]
									print('Покупка совершена, ваш остаток '+ str(money) + ' монет')
									iitems.append(items[number[0]])
					...
					while work == True:
						...
						l = input()
						if l == '1':
							if questmoney == False and questxp == False:
								r =random.randint(1,6)		
								if r == 1:
									os.system("cls")
									print('Сорян, у меня не квестов!')
									print()
								elif r >= 2 and r <=4:
									r = random.randint(50,200)
									questmoneyneed = r
									os.system("cls")
									print('Итак, ты должен накопить '+str(r)+' монет. Когда закончишь приходи')
									print()
									questmoney =True
								else:
									...
									questmoneyneed = r
									os.system("cls")
									print('Итак, ты должен накопить '+str(r)+' опыта. Когда закончишь приходи')
									print()
									questxp =True
							else:
									if questmoney == True:
										os.system("cls")
										print('У тебя уже есть квест на '+str(questmoneyneed)+' монет! Давай проваливай отсюда!')
										print()
									elif questxp == True:
										os.system("cls")
										print('У тебя уже есть квест на '+str(questxpneed)+' опыта! Давай проваливай отсюда!')
										print()
						elif l == '2':
							if questmoney == False and questxp == False:
								os.system("cls")
								print('У тебя нет активных квестов. Бери новый или проваливай отсюда')
								print()
